...
[WARNING]
====
If the link:{javadocPath}/org/gradle/api/initialization/dsl/VersionCatalogBuilder.html#from-java.lang.Object-[from] method was called once with a non-empty list of files,
any further call will result in an exception.
====
