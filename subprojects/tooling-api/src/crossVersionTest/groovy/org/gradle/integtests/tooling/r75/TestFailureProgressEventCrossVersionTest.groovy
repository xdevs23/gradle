...
"""
        ...
        assertionFailures[0].stacktrace == assertionFailures[0].description
        assertionFailures[0].expected == 'bar\n' // TODO this seems incorrect
        assertionFailures[0].actual == 'foo\n' // TODO this seems incorrect
        ...
        assertionFailures[1].stacktrace == assertionFailures[1].description
        assertionFailures[1].expected == 'class java.lang.IllegalArgumentException' // TODO we should not call toString on a class
        assertionFailures[1].actual == 'java.lang.RuntimeException'
